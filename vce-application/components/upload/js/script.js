$(document).ready(function() {
	...
	uploader.binder = function(eachUploader) {
		...
		eachUploader.find('.media-types').each(function() {
			var eachmime = {};
		...
		eachUploader.find('.file-extensions').each(function() {
		...
		uploadform.fileupload({
			...
			fail: function (e, data) {
				...
				eachUploader.find('.progressbar-error').html('File Uploader Fail Error (js): ' +  message + ' <div class="link-button cancel-button" href="">Try Again</div>').show();
				return;
			},
